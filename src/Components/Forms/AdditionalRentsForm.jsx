...
import { useSaveRentsMutation } from "../../app/Feature/API/AdditionalRents";

const AdditionalRentsForm = ({ isOpen, closeModal }) => {
  const [name, setName] = useState("");
  const [formSubmitted, setFormSubmitted] = useState(false);
  const [notification, setNotification] = useState(null);

  const [saveCategory, { isLoading }] = useSaveRentsMutation();
...
export default AdditionalRentsForm;
