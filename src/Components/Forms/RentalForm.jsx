...
const RentalForm = ({ isOpen, closeModal }) => {
    ...
    const allCategories = ["تاج", "هيربيز", "خاتم", "توينز", "طرحه", "عقد", "حلق"];
    ...
    const handleSubmit = (e) => {
        ...
        if (name && categories.length > 0 && insuranceType && deposit && status) {
                            ...
                            >
                                <Dialog.Panel className="w-full max-w-xl h-full transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <div className="mt-2 overflow-hidden h-full">
                                        {notification && (
                                            <div
                                                className={`mb-4 p-2 text-center ${notification.type === "success"
                                        ...
                                        >
                                            <div className="mb-4">
                                                ...
                                                <input
                                                    ...
                                                    className={`shadow appearance-none border ${formSubmitted && !name
                                                        ? "border-red-500"
                                                        : "border-gray-400"
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <Select
                                                    ...
                                                    isMulti
                                                    className={`shadow ${formSubmitted && categories.length === 0 ? "border-red-500" : "border-gray-400"} rounded`}
                                                    placeholder='اختر'
                                                />
                                            </div>
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <select
                                                    ...
                                                    className={`block appearance-none w-full bg-white border ${formSubmitted && !insuranceType
                                                        ? "border-red-500"
                                                        : "border-gray-400"
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <input
                                                    ...
                                                    className={`shadow appearance-none border ${formSubmitted && !deposit
                                                        ? "border-red-500"
                                                        : "border-gray-400"
                                                        } rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline`}
                                                />
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <select
                                                    ...
                                                    className={`block appearance-none w-full bg-white border ${formSubmitted && !status
                                                        ? "border-red-500"
                                                        : "border-gray-400"
                                                        } hover:border-gray-500 px-4 py-2 pr-8 rounded leading-tight focus:outline-none focus:shadow-outline`}
                                                >
                                            ...
                                            <div className="flex items-center justify-start gap-4 mt-4">
                                                <button
                                                    type="button"
                                                    onClick={closeModal}
                                                    className="bg-black text-white p-2 rounded-lg text-lg font-semibold flex items-center whitespace-nowrap"
                                                >
                                                    <AiOutlineClose className="ml-3" /> إلغاء
                                                </button>
                                                <button
                                                    type="submit"
                                                    className="bg-[#f3c74d] text-black p-2 rounded-lg text-lg font-semibold flex items-center whitespace-nowrap"
                                                >
