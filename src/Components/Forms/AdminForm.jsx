                            ...
                            >
                                <Dialog.Panel className="w-full max-w-md h-full transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <div className="mt-2">
                                        {notification && (
                                            <div
                                                className={`mt-2 mb-2 p-2 text-center ${notification.type === "success"
                                        ...
                                        <form onSubmit={handleSubmit}>
                                            <div className="mb-4">
                                                ...
                                                <Input
                                                    ...
                                                    className={`w-full ${formSubmitted && !name ? "border-red-500" : ""
                                                        }`}
                                                />
                                            </div>
                                            <div className="mb-4">
                                                ...
                                                <Input
                                                    ...
                                                    className={`w-full ${formSubmitted && !email ? "border-red-500" : ""
                                                        }`}
                                                />
                                            </div>
                                            <div className="mb-4">
                                                ...
                                                <Input
                                                    ...
                                                    className={`w-full ${formSubmitted && !phone ? "border-red-500" : ""
                                                        }`}
                                                />
                                            </div>
                                            <div className="mb-4">
                                                ...
                                                <Input
                                                    ...
                                                    className={`w-full ${formSubmitted && !password ? "border-red-500" : ""
                                                        }`}
                                                />
                                            </div>
                                            <div className="mb-4">
                                                ...
                                                <Input
                                                    ...
                                                    className={`w-full ${formSubmitted && !confirmPassword
                                                            ? "border-red-500"
                                                            : ""
                                                        }`}
                                                />
