...
import { useSaveBannerMutation } from "../../app/Feature/API/Land";

const BannerForm = ({ isOpen, closeModal }) => {
  ...
  const [saveCategory, { isLoading }] = useSaveBannerMutation();

  const handleSubmit = async (e) => {
    e.preventDefault();
    setFormSubmitted(true);

    if (name && buttonName && ButtonLink && desc && photo) {
      try {
                  ...
                  <form onSubmit={handleSubmit} className="mt-4">
                    ...
                    <div className="mb-4">
                      <label
                        ...
                        htmlFor="desc"
                      >
                        وصف االاعلان <span className="text-xl text-red-500 mt-4">*</span>
                      </label>
                      <textarea
                        id="desc"
                        value={desc}
