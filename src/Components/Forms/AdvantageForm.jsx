...
import { useSaveAdvantageLandMutation } from "../../app/Feature/API/Land";

const AdvantageForm = ({ isOpen, closeModal }) => {
  ...
  const [saveCategory, { isLoading }] = useSaveAdvantageLandMutation();
