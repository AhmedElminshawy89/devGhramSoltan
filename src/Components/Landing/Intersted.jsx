...
import { useGetImportantLandUserQuery } from '../../app/Feature/API/Land';

const Interesting = () => {
    const {data:InterestingData , isLoading , isError} = useGetImportantLandUserQuery()
    if(isError) return ;
    return (
