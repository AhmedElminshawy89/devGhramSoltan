...
import { useLazySearchStudioQuery } from "../../app/Feature/API/Search";
...
const StudioSearch = () => {
  ...
  const [triggerSearch, { isLoading }] = useLazySearchStudioQuery();
  ...
  const { refetch: refetchMakeUpDaily } = useGetStudioDailyQuery();
  ...
  const fetchSearchResults = async () => {
    ...
    setSearchData(result?.data?.studio || []);
  };
