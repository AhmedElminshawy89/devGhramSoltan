...
import { useDeleteAdvantageLandMutation, useGetAdvantageLandQuery } from "../../app/Feature/API/Land";
import UpdateImportant from "../UpdateForm/UpdateImportant";
import UpdateAdvantage from "../UpdateForm/UpdateAdvantage";

const AdvantageTable = () => {
  const [currentPage, setCurrentPage] = useState(1);
  const [perPage, setPerPage] = useState();
  const { data: packages, refetch ,isLoading} = useGetAdvantageLandQuery(currentPage);
