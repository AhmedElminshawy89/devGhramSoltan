...
import UpdateAdvantage from "../UpdateForm/UpdateAdvantage";
import { useDeleteRentsMutation, useGetRentsQuery } from "../../app/Feature/API/AdditionalRents";
import UpdateAddtional from "../UpdateForm/UpdateAddtional";

const AdditionalRentsTable = () => {
  const [currentPage, setCurrentPage] = useState(1);
  const [perPage, setPerPage] = useState();
  const { data: packages, refetch ,isLoading} = useGetRentsQuery(currentPage);
...
export default AdditionalRentsTable;