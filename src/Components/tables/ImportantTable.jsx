...
import { useDeleteImportantLandMutation, useGetImportantLandQuery } from "../../app/Feature/API/Land";
import UpdateImportant from "../UpdateForm/UpdateImportant";

const ImportantTable = () => {
  const [currentPage, setCurrentPage] = useState(1);
  const [perPage, setPerPage] = useState();
  const { data: packages, refetch ,isLoading} = useGetImportantLandQuery(currentPage);
